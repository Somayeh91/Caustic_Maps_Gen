...
def parse_options():
    ...
    parser.add_argument('-mem', action='store', default='4000', help='Needed memory.')
    parser.add_argument('-n_cpu', action='store', default='4', help='Number of cpus per task.')
...
""".format(partition=partition, python_file=python_file, date=date, arguments=arguments, mem=mem,
           n_gpu=n_gpu, n_cpu=n_gpu, n_hrs=n_hrs, jobname=jobname, outfilename=outfilename,
